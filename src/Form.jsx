...
function Form(){
    ...
    return(
        <div>
            ...
            <input type="radio" style={{marginRight:"1%"}}/>Onshore
            <div>
            <input class="form-control form-control-lg" type="text" placeholder="Select Location"/><br/>
            </div>
            <div style={{alignItems:"center"}}>
            <input type="checkbox"/>HTML5,CSS3,JS
            <input type="checkbox"/>Angular 8
            <input type="checkbox"/>Express JS<br/>
            <input type="checkbox"/>SASS
            <input type="checkbox"/>React JS
            <input type="checkbox"/>MongoDB<br/>
            <input type="checkbox"/>ES5,ES6,ES7...
            <input type="checkbox"/>Veu JS
            <input type="checkbox"/>MERN<br/>
            <input type="checkbox"/>Bootstrap 4
            <input type="checkbox"/>TypeScript<br/><br/>
            </div>
